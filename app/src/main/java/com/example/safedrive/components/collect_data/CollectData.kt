package com.example.safedrive.components.CollectData
...
//    }
    ...
    override fun onCreateView(
        ...
        val activty = getArguments()?.getString("activity")
        val textView: TextView = (R.id.textView) as TextView
