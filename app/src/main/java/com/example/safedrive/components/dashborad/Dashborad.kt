package com.example.safedrive.components.dashborad
...
class Dashborad : Fragment() {
    ...
    private val stateCallback = object : CameraDevice.StateCallback() {
        ...
        override fun onOpened(cameraDevice: CameraDevice) {
            ...
            this@Dashborad.cameraDevice = cameraDevice
        ...
        override fun onDisconnected(cameraDevice: CameraDevice) {
            cameraOpenCloseLock.release()
            cameraDevice.close()
            this@Dashborad.cameraDevice = null
        }

        override fun onError(cameraDevice: CameraDevice, error: Int) {
            onDisconnected(cameraDevice)
            this@Dashborad.activity?.finish()
        }
    }
...
//    }
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.dashborad, container, false)
    }
